...
func (a *AccountServiceServer) toDomain(req *accountv1.CreditRequest) domain.Credit {
	return domain.Credit{
		Biz:   req.Biz,
		BizId: req.BizId,
		Items: slice.Map(req.Items, func(idx int, src *accountv1.CreditItem) domain.CreditItem {

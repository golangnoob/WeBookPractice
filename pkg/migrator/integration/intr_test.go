...
import (
	...
	events2 "webooktrial/pkg/migrator/events"
	evtmocks "webooktrial/pkg/migrator/events/mocks"
	"webooktrial/pkg/migrator/integration/startup"
	gorm2 "webooktrial/pkg/migrator/validator"
)
	...
	for _, tc := range testCases {
		i.T().Run(tc.name, func(t *testing.T) {
			...
			v := gorm2.NewValidator[Interactive](i.srcDB, i.intrDB,
				logger.NewNopLogger(), tc.mock(ctrl), "SRC")

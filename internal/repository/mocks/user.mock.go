...
// Source: E:\webooktrial\internal\repository\user.go
...
func (m *MockUserRepository) FindProfile(ctx context.Context, id int64) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindProfile", ctx, id)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) FindProfile(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindProfile", reflect.TypeOf((*MockUserRepository)(nil).FindProfile), ctx, id)
}

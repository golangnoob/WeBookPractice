...
// Source: E:\webooktrial\internal\repository\dao\user.go
...
func (m *MockUserDAO) Select(ctx context.Context, id int64) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOMockRecorder) Select(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Select", reflect.TypeOf((*MockUserDAO)(nil).Select), ctx, id)
}

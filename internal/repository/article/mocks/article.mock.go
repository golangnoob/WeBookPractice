...
// Source: E:\webooktrial\internal\repository\article\gorm.go
...
func (m *MockArticleRepository) SyncStatus(ctx *gin.Context, id, author int64, status domain.ArticleStatus) error {
	m.ctrl.T.Helper()
